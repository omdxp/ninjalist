    ...
    <>
      ...
      <div>
        ...
        <p className={styles.text}>
          ...
          nulla. Veniam dolor sint excepteur occaecat proident ullamco magna
          Lorem in. Proident ad et excepteur do do irure. Voluptate quis
          proident fugiat fugiat labore irure amet culpa ullamco labore.
        </p>
        <p className={styles.text}>
